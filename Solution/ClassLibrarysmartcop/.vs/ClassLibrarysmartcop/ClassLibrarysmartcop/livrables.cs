    ...
    public static class Livrables
    {
        public static void CreateLivrablesPanel(RibbonPanelSource livrablesPanelSource, RibbonPanel livrablesPanel)
        {
            try
            {
                ...
                RibbonButton ajustementBtn = CreateButton("Ajustement", @"C:\Users\hp\source\repos\ClassLibrarysmartcop\ClassLibrarysmartcop\img\ajustement.png", true ,new AjustementCommand());
                RibbonButton genererBtn = CreateButton("Générer", @"C:\Users\hp\source\repos\ClassLibrarysmartcop\ClassLibrarysmartcop\img\generer.png", true,new GenerateCommand());
                ...
                RibbonButton messagesBtn = CreateButton("Messages: 0", @"C:\Users\hp\source\repos\ClassLibrarysmartcop\ClassLibrarysmartcop\img\!.png");
