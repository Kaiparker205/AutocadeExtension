    ...
    static class Dessin
    {
        public static void CreateInitialPanels(RibbonPanelSource projetPanelSource, RibbonPanel projetPanel)
        {
            try
            {
                ...
                RibbonButton habillageBtn = CreateButton("Habillage", @"C:\Users\hp\source\repos\ClassLibrarysmartcop\ClassLibrarysmartcop\img\Habillage.png",true,new HabillageCommand());
                RibbonButton tableauBtn = CreateButton("Tableau des contenances", @"C:\Users\hp\source\repos\ClassLibrarysmartcop\ClassLibrarysmartcop\img\tableau.png", true, new TableauCommand());
                RibbonButton calquesBtn = CreateButton("Calques", @"C:\Users\hp\source\repos\ClassLibrarysmartcop\ClassLibrarysmartcop\img\Calques.png", true, new CalquesCommand());
